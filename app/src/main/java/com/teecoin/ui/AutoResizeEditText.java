...
public class AutoResizeEditText extends AppCompatEditText {
    ...
    private final AutoResizeEditText.SizeTester mSizeTester = new AutoResizeEditText.SizeTester() {
...
//    }
    private int efficientTextSizeSearch(int start, int end,
                                        AutoResizeEditText.SizeTester sizeTester, RectF availableSpace) {
        if (!mEnableSizeCache) {
    ...
    private static int binarySearch(int start, int end, AutoResizeEditText.SizeTester sizeTester,
