...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            colorBorder = colorOn = getResources().getColor(R.color.c_b2973f, getContext().getTheme());
        } else {
            colorBorder = colorOn = getResources().getColor(R.color.c_b2973f);
        }
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.Toggle_on) {
                ...
                int accentColor;
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    accentColor = getResources().getColor(R.color.c_b2973f, getContext().getTheme());
                } else {
                    accentColor = getResources().getColor(R.color.c_b2973f);
                }
...
//      Drawing Switch Thumb here
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int desiredWidth = getResources().getDimensionPixelSize(R.dimen.fs_72);
        int desiredHeight = getResources().getDimensionPixelSize(R.dimen.fs_25);
