...
public class CompressFile {
    public static File getCompressedImageFile(File file, Context mContext) {
        try {
            ...
            int scale = 2;// use scale =2: means reduce image resolution 50%
...
//            }
            ...
            File newFile = CameraUtils.createImageFileWith(getFileExt(file.getName()));
            if (newFile.exists()) {
                newFile.delete();
            }
    ...
    public static File simpleCompressImage() {
        return null;
    }
}
