...
public class GeneralLogoutAccountRequest extends GeneralApiRequest {

    private RegisterNotifyModel registerNotifyModel;

    public GeneralLogoutAccountRequest(RegisterNotifyModel registerNotifyModel, GeneralRequestTarget requestTarget, APIResponseListener listener) {
    ...
    public void requestApi(GeneralApiManager generalApiManager, Context context) {
        generalApiManager.accountLogout(
                String.format(requestTarget.toString(), getAccountUUID()), registerNotifyModel)
