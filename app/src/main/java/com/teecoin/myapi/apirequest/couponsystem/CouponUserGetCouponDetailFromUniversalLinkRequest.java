...
public class CouponUserGetCouponDetailFromUniversalLinkRequest extends CouponApiRequest {

    private String requestApiUrl;

    public CouponUserGetCouponDetailFromUniversalLinkRequest(String requestApiUrl, APIResponseListener listener) {
    ...
    public void requestApi(CouponApiManager couponApiManager, Context context) {
        couponApiManager.getDetailCouponCatalogue(requestApiUrl, getUserToken())
