...
public class WalletGetPaymentDetailRequest extends WalletApiRequest {


    private String transactionId;

    public WalletGetPaymentDetailRequest(String transactionId, APIResponseListener listener) {
        super(true, WalletRequestTarget.GET_PAYMENT_DETAIL, listener);
        this.transactionId = transactionId;
    }

    @Override
    public void requestApi(WalletApiManager walletApiManager, Context context) {
        walletApiManager.getPaymentDetail(
