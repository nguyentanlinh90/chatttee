...
public class WalletGetTransferMoneyDetailRequest extends WalletApiRequest {


    private String transactionId;

    public WalletGetTransferMoneyDetailRequest(String transactionId, APIResponseListener listener) {
        super(true, WalletRequestTarget.GET_TRANSFER_MONEY_DETAIL, listener);
        this.transactionId = transactionId;
    }

    @Override
    public void requestApi(WalletApiManager walletApiManager, Context context) {
        walletApiManager.getTransferMoneyDetail(
