...
public class WalletGetWithdrawDetail extends WalletApiRequest {


    private String transactionId;

    public WalletGetWithdrawDetail(String transactionId, APIResponseListener listener) {
        super(true, WalletRequestTarget.GET_WITHDRAW_COMPLETED_DETAIL, listener);
        this.transactionId = transactionId;
    }

    @Override
    public void requestApi(WalletApiManager walletApiManager, Context context) {
        walletApiManager.getWithdrawDetail(
