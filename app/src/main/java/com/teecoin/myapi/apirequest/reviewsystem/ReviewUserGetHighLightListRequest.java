...
public class ReviewUserGetHighLightListRequest extends ReviewApiRequest {


    public ReviewUserGetHighLightListRequest(APIResponseListener listener) {
        super(false, ReviewRequestTarget.GET_LIST_HIGHLIGHT, listener);
    }

    @Override
    public void requestApi(ReviewApiManager reviewApiManager, Context context) {
        reviewApiManager.getListHighLight(requestTarget.toString())
