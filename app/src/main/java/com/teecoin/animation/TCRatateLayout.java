...
//import makevideo.coin.tee.customlayout.R;

public class TCRatateLayout extends ViewGroup {
    ...
    //https://github.com/rongi/rotate-layout#download
    // https://github.com/florent37/ShapeOfView
    private int angle;
    private boolean angleChanged = true;

    public TCRatateLayout(Context context) {
        this(context, null);
    }

    public TCRatateLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TCRatateLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
