...
public class DisCoverVendorCatalogueNameAdapter  extends RecycleAdapter<VendorCategoryModel> {
    String idCatalogueSelect;
    public DisCoverVendorCatalogueNameAdapter(LayoutInflater inflater, ArrayList<VendorCategoryModel> items, RecycleListener<VendorCategoryModel> listener) {
    ...
    protected Class<? extends ItemViewHolder> getItemViewHolderClass() {
        return DiscoverVendorCatalogueNameViewHolder.class;
    }
    ...
    protected int getItemLayoutResource() {
        return R.layout.item_coupon_category_name;
    }

    @Override
    protected void bindItemView(ItemViewHolder<VendorCategoryModel> holder, VendorCategoryModel data, int position) {
        if (holder instanceof DiscoverVendorCatalogueNameViewHolder) {
            DiscoverVendorCatalogueNameViewHolder viewHolder = (DiscoverVendorCatalogueNameViewHolder) holder;
