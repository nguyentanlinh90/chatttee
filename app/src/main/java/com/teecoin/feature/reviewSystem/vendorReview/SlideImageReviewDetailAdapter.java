...
public class SlideImageReviewDetailAdapter extends PagerAdapter {
    private ArrayList<ImagesResponseModel>listData;
    ...
    public SlideImageReviewDetailAdapter(Context context, ArrayList<ImagesResponseModel>listImages, boolean zoom, boolean from_video) {
