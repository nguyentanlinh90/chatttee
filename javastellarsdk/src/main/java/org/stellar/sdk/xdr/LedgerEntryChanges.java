...
public class LedgerEntryChanges  {
  ...
  public static void encode(XdrDataOutputStream stream, org.stellar.sdk.xdr.LedgerEntryChanges encodedLedgerEntryChanges) throws IOException {
  ...
  public static org.stellar.sdk.xdr.LedgerEntryChanges decode(XdrDataInputStream stream) throws IOException {
    org.stellar.sdk.xdr.LedgerEntryChanges decodedLedgerEntryChanges = new LedgerEntryChanges();
